RSpec.shared_context 'phase_2_bundle' do
  ...
  let(:phase_2_part_1_product) { build_spree_product(name: 'Boy Brow', master: phase_2_master_variant, variants: [phase_2_part_1_variant_1, phase_2_part_1_variant_2]) }
  ...
  let(:phase_2_part_2_product) { build_spree_product(name: 'Generation G', master: phase_2_master_variant, variants: [phase_2_part_2_variant_1, phase_2_part_2_variant_2]) }
  ...
  let(:phase_2_part_3_product) { build_spree_product(name: 'Stretch Concealer', master: phase_2_master_variant, variants: [phase_2_part_3_variant_1, phase_2_part_3_variant_2]) }
